...
const navTree = [
  {
    ...
    key: 'use-case',
    items: [
      { label: 'Vay Nhanh', href: '/projects/vay-nhanh-strategy', tag: 'LIVE' },
      { label: 'Ví Trả Sau', href: '/projects/vi-tra-sau-bnpl', tag: 'REVIEW' },
      { label: 'Tín Dụng', href: '/projects/credit-ecosystem', tag: 'LIVE' },
      { label: 'Bảo Hiểm Xe Máy', href: '/projects/bao-hiem-xe-may', tag: 'LIVE' },
      { label: 'Bảo Hiểm', href: '/projects/bao-hiem-hub', tag: 'LIVE' },
      { label: 'Bảo Hiểm Ô Tô', href: '/projects/bao-hiem-o-to', tag: 'LIVE' },
      { label: 'Đối Tác', href: '/projects/doi-tac-directory', tag: 'DRAFT' },
      { label: 'Viễn Thông', href: '/projects/telco-hub', tag: 'LIVE' },
      { label: 'Du Lịch', href: '/projects/travel-hub', tag: 'LIVE' },
